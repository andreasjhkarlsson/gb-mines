...
const int about_tile_map_size = 0x0168;
const int about_tile_map_width = 0x14;
const int about_tile_map_height = 0x12;

const int about_tile_data_size = 0x0D70;
const int about_tile_count = 0xD7;

const unsigned char about_map_data[] = {
...
const unsigned char about_tile_data[] = {
...
{
	HIDE_BKG;
	set_bkg_data(0, about_tile_data_size/16, about_tile_data);
	set_bkg_tiles(0, 0, about_tile_map_width, about_tile_map_height, about_map_data);
	SHOW_BKG;
